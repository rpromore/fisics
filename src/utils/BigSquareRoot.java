// Following code from http://www.merriampark.com/bigsqrt.htm

// The following source code (BigSquareRoot.java) is free for you to use in whatever way you wish, 
// with no restrictions and no guarantees. Improvements and constructive suggestions are welcome. 
// Note that, when computing very large square roots, you should use a large scale. 
