...
public class ObjTest extends AbstractScreen implements InputProcessor {
    public ObjTest(Sandbox game) {
		super(game);
	}
    ...
    @Override
    public void show () {
            mesh = ModelLoaderOld.loadObj(Gdx.files.internal("data/sphere.obj").read());
